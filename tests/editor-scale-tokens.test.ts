...
// 票 72（2026-09-24）解冻过一次 —— 那一票就是修这个组件的视口拟合，所以按 S0 §六.3
// 只换值 + 留痕，B2 那条断言一个字没删。旧值
// d11175e9134438eaba4018cfa14f9d5add5b7525f5281ffa22c29a1956b9282f。
const GRAPH_HASH = 'efdd93c79f034529f1807b9ac0f162e388a8f553ebfa339578d1ae403981408c'
